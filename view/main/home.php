...
<div class="container-fluid ">
	<div class="container">
		...
		<div class="row boderbot" style="margin-top : 30px">
		...
		<div class="row boderbot ">
	         	...
	         	<div class="item2">
	         		<a  href="index.php?view=chitietsanpham&masp=<?php echo $kq_dssp['MaSP']; ?>" >
						...
						<div class="item-text ft text-center">
							<h6 style="color:white;font-weight:bold" ><?php echo $kq_dssp['TenSP']?></h6>
			<?php   	if ($a!==0 || $b!==0) {?>
			...
			<?php $t=0; if($b==0){$t=$kq_dssp['DonGia']-$a;}else{$t=($kq_dssp['DonGia']-($kq_dssp['DonGia']*$b)/100)-$a;}?>
				  ...
				  <?php }?>
				         	<p style="color:white" ><?php echo ($kq_ncc['TenNCC']) ; ?></p>
